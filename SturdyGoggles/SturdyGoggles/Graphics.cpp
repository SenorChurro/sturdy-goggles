...
Graphics::Graphics(HWND hWnd)
{
	...
	//SampleDesc.Count and SampleDesc.Quality are used for AntiAliasing in the future
	...
	// create the view of the depth stencil texure
...
{
	return "Sturdy Goggles Graphics Exception";
}
